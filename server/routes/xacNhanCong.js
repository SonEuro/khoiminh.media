...
router.get('/', requireAuth, (req, res) => {
  ...
  const salaryRows = db.prepare('SELECT full_name, luong_co_ban, luong_ngay_cong, luong_ot_h, bac_luong, luong_theo_thang, phu_cap FROM users WHERE full_name IS NOT NULL').all();
  const salaryByName = {};
