...
router.post('/login', (req, res) => {
  ...
  const payload = { id: user.id, username: user.username, role: user.role, full_name: user.full_name, position: user.position || '', is_truong_phong: !!user.is_truong_phong, is_phan_lich: !!user.is_phan_lich, is_phan_lich_all: !!user.is_phan_lich_all, is_tra_ncc: !!user.is_tra_ncc };
