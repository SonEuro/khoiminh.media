...
const { checkAndCreateViolations, scheduleObligationsCheck } = require('./services/obligations');
...
app.use('/api/van-hanh-ke-toan', requireAuth, require('./routes/vanHanhKeToan'));
app.use('/api/xac-nhan-cong',   requireAuth, require('./routes/xacNhanCong'));
...
app.listen(PORT, async () => {
  ...
  scheduleObligationsCheck(); // finalize vi phạm báo cáo lúc 23:59
});
