...
export const api = {
  ...
  markViolationSupplemented: (id) => request(`/violations/${id}/mark-supplemented`, { method: 'PATCH' }),
  ...
  getNgayPhep: (year, month) => request(`/ngay-phep?year=${year}&month=${month || ''}`),
  getNgayPhepRecords: (userId) => request(`/ngay-phep/records/${userId}`),
  updatePhepNam: (userId, phep_nam) => request(`/ngay-phep/user/${userId}`, { method: 'PUT', body: { phep_nam } }),
  addNgayPhepRecord: (body) => request(`/ngay-phep/record`, { method: 'POST', body }),
  deleteNgayPhepRecord: (id) => request(`/ngay-phep/record/${id}`, { method: 'DELETE' }),
  setNgayPhepOverride: (body) => request(`/ngay-phep/override`, { method: 'PUT', body }),
  clearNgayPhepOverride: (body) => request(`/ngay-phep/override`, { method: 'DELETE', body }),
  ...
  notifyEvent:           (id) => request(`/events/${id}/notify`,            { method: 'POST' }),
