...
export default function Layout() {
  ...
  return (
    <div style={{ display:'flex', height:'100dvh', overflow:'hidden', background:'var(--bg-card)' }}>
      ...
      <div style={{ flex:1, display:'flex', flexDirection:'column', overflow:'hidden' }}>
        ...
        >
          ...
          {/* Logo */}
          <Link to="/" onClick={() => { window.location.href = '/'; }}><img src="/logo.png" alt="Khôi Minh" style={{ height:'42px', display:'block' }} /></Link>
