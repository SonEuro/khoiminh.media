...
<table class="main-table">
  ...
  const previewStyle = `
  .top-bar { position:fixed; top:0; left:0; right:0; background:#1a1a2e; color:#e8c97a; padding:10px 16px; display:flex; align-items:center; justify-content:space-between; font-family:sans-serif; font-size:13px; z-index:9999; border-bottom:2px solid #c9a84c; }
  .btn-print { padding:7px 18px; border-radius:6px; border:none; cursor:pointer; font-size:13px; font-weight:700; background:linear-gradient(135deg,#b8922e,#e8c97a); color:#000; }
  .btn-close { padding:7px 18px; border-radius:6px; border:1px solid rgba(255,255,255,0.25); cursor:pointer; font-size:13px; font-weight:700; background:rgba(255,255,255,0.1); color:#fff; font-family:sans-serif; }
